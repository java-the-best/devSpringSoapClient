...
import localhost.devSpringSoapClient.wsdl.GetCountryRequest;
...
public class CountryClient extends WebServiceGatewaySupport {
  ...
  private static final Logger log =
      LoggerFactory.getLogger(CountryClient.class);
    ...
    GetCountryResponse response =
        (GetCountryResponse) getWebServiceTemplate().marshalSendAndReceive(
            ...
            new SoapActionCallback(
                "http://localhost.devSpringSoapClient/GetCountryRequest"));
